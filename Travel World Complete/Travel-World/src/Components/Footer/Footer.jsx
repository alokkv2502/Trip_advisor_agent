        ...
        <Row>
          <Col lg="3">
            <div className="logo">
              <img src={logo} alt="" />
              <p>
              Explore the world with us. Join now for unforgettable journeys and enriching travel experiences.
              </p>
          ...
          <Col lg="12" className="text-center pt-5">
            <p className="copyright">
              ...
              <Link to="https://www.linkedin.com/in/chandan-kumar-61008b223">Code_Chandan</Link>
            </p>
          </Col>
        </Row>
      </Container>
